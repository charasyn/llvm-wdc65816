...
extern bool WDC65816ReserveGP;
extern bool WDC65816NoCpload;
...
protected:
  // These define which ISA is supported. Since each Motorola WDC65816 ISA is
  ...
  std::bitset<WDC65816::NUM_TARGET_REGS> UserReservedRegister;
...
public:
  ...
  WDC65816Subtarget(const Triple &TT, StringRef CPU, StringRef FS,
                const WDC65816TargetMachine &_TM);
  ...
  bool isRegisterReservedByUser(Register R) const {
    assert(R < WDC65816::NUM_TARGET_REGS && "Register out of range");
  ...
  WDC65816Subtarget &initializeSubtargetDependencies(StringRef CPU, Triple TT,
                                                 StringRef FS,
                                                 const WDC65816TargetMachine &TM);
  ...
  const WDC65816FrameLowering *getFrameLowering() const override {
    return &FrameLowering;
  }

  const WDC65816RegisterInfo *getRegisterInfo() const override {
...
#endif // LLVM_LIB_TARGET_WDC65816_WDC65816SUBTARGET_H
