...
///
/// \file
/// This file contains the WDC65816 declaration of TargetFrameLowering class.
///
//===----------------------------------------------------------------------===//
...
public:
  explicit WDC65816FrameLowering(const WDC65816Subtarget &sti, Align Alignment);

  static const WDC65816FrameLowering *create(const WDC65816Subtarget &ST);
  ...
  //
  // So, this is required for WDC65816 functions that have push sequences even
...
#endif // LLVM_LIB_TARGET_WDC65816_WDC65816FRAMELOWERING_H
