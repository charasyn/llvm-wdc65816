//===-- WDC65816ISelLowering.cpp - WDC65816 DAG Lowering Impl -----------*- C++ -*-===//
//
...
WDC65816TargetLowering::WDC65816TargetLowering(const WDC65816TargetMachine &TM,
  ...
  addRegisterClass(MVT::i8, &WDC65816::DR8RegClass);
  addRegisterClass(MVT::i16, &WDC65816::XR16RegClass);
  addRegisterClass(MVT::i32, &WDC65816::XR32RegClass);
  ...
  // WDC65816 does not have native read-modify-write support, so expand all of them
...
WDC65816TargetLowering::shouldExpandAtomicRMWInIR(AtomicRMWInst *RMW) const {
...
Register
WDC65816TargetLowering::getExceptionPointerRegister(const Constant *) const {
  return WDC65816::D0;
}

Register
WDC65816TargetLowering::getExceptionSelectorRegister(const Constant *) const {
  return WDC65816::D1;
}

InlineAsm::ConstraintCode
WDC65816TargetLowering::getInlineAsmMemConstraint(StringRef ConstraintCode) const {
...
EVT WDC65816TargetLowering::getSetCCResultType(const DataLayout &DL,
                                           LLVMContext &Context, EVT VT) const {
  // WDC65816 SETcc producess either 0x00 or 0xFF
  return MVT::i8;
}

MVT WDC65816TargetLowering::getScalarShiftAmountTy(const DataLayout &DL,
                                               EVT Ty) const {
  if (Ty.isSimple()) {
...
static bool MatchingStackOffset(SDValue Arg, unsigned Offset,
  ...
  if (Arg.getOpcode() == ISD::CopyFromReg) {
    ...
    if (!Flags.isByVal()) {
      ...
      if ((Opcode == WDC65816::LEA32p || Opcode == WDC65816::LEA32f) &&
...
SDValue
WDC65816TargetLowering::getReturnAddressFrameIndex(SelectionDAG &DAG) const {
...
SDValue WDC65816TargetLowering::EmitTailCallLoadRetAddr(SelectionDAG &DAG,
                                                    SDValue &OutRetAddr,
                                                    SDValue Chain,
...
SDValue WDC65816TargetLowering::EmitTailCallStoreRetAddr(
...
SDValue
WDC65816TargetLowering::LowerMemArgument(SDValue Chain, CallingConv::ID CallConv,
...
SDValue WDC65816TargetLowering::LowerMemOpCallTo(SDValue Chain, SDValue StackPtr,
...
SDValue WDC65816TargetLowering::LowerCall(TargetLowering::CallLoweringInfo &CLI,
  ...
  // const WDC65816RegisterInfo *TRI = Subtarget.getRegisterInfo();

  if (CallConv == CallingConv::WDC65816_INTR)
    report_fatal_error("WDC65816 interrupts may not be called directly");
  ...
  WDC65816CCState CCInfo(ArgTypes, CallConv, IsVarArg, MF, ArgLocs,
                     *DAG.getContext());
  CCInfo.AnalyzeCallOperands(Outs, CC_WDC65816);
  ...
  const WDC65816RegisterInfo *RegInfo = Subtarget.getRegisterInfo();
  ...
  if (Callee->getOpcode() == ISD::GlobalAddress) {
    ...
    if (!GV->hasDLLImportStorageClass()) {
      ...
      if (OpFlags == WDC65816II::MO_GOTPCREL) {

        // Add a wrapper.
        Callee = DAG.getNode(WDC65816ISD::WrapperPC, DL,
  ...
  if (IsTailCall) {
    ...
    return DAG.getNode(WDC65816ISD::TC_RETURN, DL, NodeTys, Ops);
  }

  Chain = DAG.getNode(WDC65816ISD::CALL, DL, NodeTys, Ops);
  InGlue = Chain.getValue(1);

  // Create the CALLSEQ_END node.
  unsigned NumBytesForCalleeToPop;
  if (WDC65816::isCalleePop(CallConv, IsVarArg,
...
SDValue WDC65816TargetLowering::LowerCallResult(
  ...
  CCState CCInfo(CallConv, IsVarArg, DAG.getMachineFunction(), RVLocs,
                 *DAG.getContext());
  CCInfo.AnalyzeCallResult(Ins, RetCC_WDC65816);
...
SDValue WDC65816TargetLowering::LowerFormalArguments(
    SDValue Chain, CallingConv::ID CCID, bool IsVarArg,
    const SmallVectorImpl<ISD::InputArg> &Ins, const SDLoc &DL,
    SelectionDAG &DAG, SmallVectorImpl<SDValue> &InVals) const {
  MachineFunction &MF = DAG.getMachineFunction();
  WDC65816MachineFunctionInfo *MMFI = MF.getInfo<WDC65816MachineFunctionInfo>();
  ...
  WDC65816CCState CCInfo(ArgTypes, CCID, IsVarArg, MF, ArgLocs, *DAG.getContext());

  CCInfo.AnalyzeFormalArguments(Ins, CC_WDC65816);
  ...
  if (IsVarArg && MFI.hasMustTailInVarArgFunc()) {
    ...
    CCInfo.analyzeMustTailForwardedRegisters(Forwards, RegParmTypes, CC_WDC65816);
  ...
  if (WDC65816::isCalleePop(CCID, IsVarArg,
...
bool WDC65816TargetLowering::CanLowerReturn(
...
SDValue
WDC65816TargetLowering::LowerReturn(SDValue Chain, CallingConv::ID CCID,
                                bool IsVarArg,
  ...
  CCInfo.AnalyzeReturn(Outs, RetCC_WDC65816);
  ...
  if (unsigned SRetReg = MFI->getSRetReturnReg()) {
    ...
    unsigned RetValReg = WDC65816::D0;
  ...
  return DAG.getNode(WDC65816ISD::RET, DL, MVT::Other, RetOps);
}
...
//  On WDC65816_64 architecture with GOT-style position independent code only
...
/// requirement.
unsigned
WDC65816TargetLowering::GetAlignedArgumentStackSize(unsigned StackSize,
...
bool WDC65816TargetLowering::IsEligibleForTailCallOptimization(
  ...
  if (!CCState::resultsCompatible(CalleeCC, CallerCC, MF, C, Ins, RetCC_WDC65816,
                                  RetCC_WDC65816))
    return false;
  ...
  if (!Outs.empty()) {
    ...
    if (StackArgsSize) {
      ...
      const WDC65816InstrInfo *TII = Subtarget.getInstrInfo();
      for (unsigned i = 0, e = ArgLocs.size(); i != e; ++i) {
        CCValAssign &VA = ArgLocs[i];
        SDValue Arg = OutVals[i];
        ISD::ArgFlagsTy Flags = Outs[i].Flags;
  ...
  bool CalleeWillPop = WDC65816::isCalleePop(
      CalleeCC, IsVarArg, MF.getTarget().Options.GuaranteedTailCallOpt);

  if (unsigned BytesToPop =
          MF.getInfo<WDC65816MachineFunctionInfo>()->getBytesToPopOnReturn()) {
...
SDValue WDC65816TargetLowering::LowerExternalSymbolCall(SelectionDAG &DAG,
                                                    SDLoc Loc,
...
SDValue WDC65816TargetLowering::getTLSGetAddr(GlobalAddressSDNode *GA,
                                          SelectionDAG &DAG,
...
SDValue WDC65816TargetLowering::getWDC65816ReadTp(SDLoc Loc, SelectionDAG &DAG) const {
  return LowerExternalSymbolCall(DAG, Loc, "__m68k_read_tp", ArgListTy());
}

SDValue WDC65816TargetLowering::LowerTLSGeneralDynamic(GlobalAddressSDNode *GA,
                                                   SelectionDAG &DAG) const {
  return getTLSGetAddr(GA, DAG, WDC65816II::MO_TLSGD);
}

SDValue WDC65816TargetLowering::LowerTLSLocalDynamic(GlobalAddressSDNode *GA,
                                                 SelectionDAG &DAG) const {
  SDValue Addr = getTLSGetAddr(GA, DAG, WDC65816II::MO_TLSLDM);
  SDValue TGA =
      DAG.getTargetGlobalAddress(GA->getGlobal(), GA, GA->getValueType(0),
                                 GA->getOffset(), WDC65816II::MO_TLSLD);
  return DAG.getNode(ISD::ADD, SDLoc(GA), MVT::i32, TGA, Addr);
}

SDValue WDC65816TargetLowering::LowerTLSInitialExec(GlobalAddressSDNode *GA,
                                                SelectionDAG &DAG) const {
  SDValue GOT = DAG.getGLOBAL_OFFSET_TABLE(MVT::i32);
  SDValue Tp = getWDC65816ReadTp(SDLoc(GA), DAG);
  SDValue TGA =
      DAG.getTargetGlobalAddress(GA->getGlobal(), GA, GA->getValueType(0),
                                 GA->getOffset(), WDC65816II::MO_TLSIE);
...
SDValue WDC65816TargetLowering::LowerTLSLocalExec(GlobalAddressSDNode *GA,
                                              SelectionDAG &DAG) const {
  SDValue Tp = getWDC65816ReadTp(SDLoc(GA), DAG);
  SDValue TGA =
      DAG.getTargetGlobalAddress(GA->getGlobal(), GA, GA->getValueType(0),
                                 GA->getOffset(), WDC65816II::MO_TLSLE);
...
bool WDC65816TargetLowering::decomposeMulByConstant(LLVMContext &Context, EVT VT,
                                                SDValue C) const {
...
static void lowerOverflowArithmetic(SDValue Op, SelectionDAG &DAG,
  ...
  case ISD::UMULO:
    ...
    BaseOp = NoOverflow ? ISD::MUL : WDC65816ISD::UMUL;
    CC = WDC65816::COND_VS;
    break;
  case ISD::SMULO:
    PromoteMULO(ISD::SIGN_EXTEND);
    NoOverflow = VT != MVT::i32;
    BaseOp = NoOverflow ? ISD::MUL : WDC65816ISD::SMUL;
    CC = WDC65816::COND_VS;
    break;
  }
...
SDValue WDC65816TargetLowering::LowerXALUO(SDValue Op, SelectionDAG &DAG) const {
  SDNode *N = Op.getNode();
  SDLoc DL(Op);
  ...
  if (isa<ConstantSDNode>(CCR)) {
    ...
    // Generate a WDC65816ISD::SETCC.
    Overflow = DAG.getNode(WDC65816ISD::SETCC, DL, N->getValueType(1),
...
static SDValue getBitTestCondition(SDValue Src, SDValue BitNo, ISD::CondCode CC,
  ...
  SDValue BTST = DAG.getNode(WDC65816ISD::BTST, DL, MVT::i32, Src, BitNo);

  // NOTE BTST sets CCR.Z flag
  WDC65816::CondCode Cond = CC == ISD::SETEQ ? WDC65816::COND_NE : WDC65816::COND_EQ;
  return DAG.getNode(WDC65816ISD::SETCC, DL, MVT::i8,
...
static WDC65816::CondCode TranslateIntegerWDC65816CC(ISD::CondCode SetCCOpcode) {
  switch (SetCCOpcode) {
  default:
...
/// Do a one-to-one translation of a ISD::CondCode to the WDC65816-specific
/// condition code, returning the condition code and the LHS/RHS of the
/// comparison to make.
static unsigned TranslateWDC65816CC(ISD::CondCode SetCCOpcode, const SDLoc &DL,
  ...
  if (!IsFP) {
    ...
    return TranslateIntegerWDC65816CC(SetCCOpcode);
  }
...
SDValue WDC65816TargetLowering::EmitTest(SDValue Op, unsigned WDC65816CC,
                                     const SDLoc &DL, SelectionDAG &DAG) const {
  ...
  if (Op.getResNo() != 0 || NeedOF || NeedCF) {
    ...
    return DAG.getNode(WDC65816ISD::CMP, DL, MVT::i8,
  ...
  case ISD::SRL:
    ...
    if ((WDC65816CC == WDC65816::COND_EQ || WDC65816CC == WDC65816::COND_NE) &&
  ...
  case ISD::AND:
    ...
    // WDC65816ISD::AND, because a TEST instruction will be better.
  ...
  case ISD::XOR:
    ...
    case ISD::SUB:
      Opcode = WDC65816ISD::SUB;
      break;
    case ISD::XOR:
      Opcode = WDC65816ISD::XOR;
      break;
    case ISD::AND:
      Opcode = WDC65816ISD::AND;
      break;
    case ISD::OR:
      Opcode = WDC65816ISD::OR;
      break;
    }

    NumOperands = 2;
    break;
  case WDC65816ISD::ADD:
  case WDC65816ISD::SUB:
  case WDC65816ISD::OR:
  case WDC65816ISD::XOR:
  case WDC65816ISD::AND:
  ...
  if (NeedTruncation) {
    ...
    default:
      break;
    case ISD::ADD:
      ConvertedOp = WDC65816ISD::ADD;
      break;
    case ISD::SUB:
      ConvertedOp = WDC65816ISD::SUB;
      break;
    case ISD::AND:
      ConvertedOp = WDC65816ISD::AND;
      break;
    case ISD::OR:
      ConvertedOp = WDC65816ISD::OR;
      break;
    case ISD::XOR:
      ConvertedOp = WDC65816ISD::XOR;
      break;
    }
...
static bool isWDC65816CCUnsigned(unsigned WDC65816CC) {
  switch (WDC65816CC) {
  default:
    llvm_unreachable("Invalid integer condition!");
...
SDValue WDC65816TargetLowering::EmitCmp(SDValue Op0, SDValue Op1, unsigned WDC65816CC,
                                    const SDLoc &DL, SelectionDAG &DAG) const {
  if (isNullConstant(Op1))
    return EmitTest(Op0, WDC65816CC, DL, DAG);
  ...
  if ((Op0.getValueType() == MVT::i8 || Op0.getValueType() == MVT::i16 ||
    ...
    if ((Op0.getValueType() == MVT::i16 &&
      ...
      unsigned ExtendOp =
          isWDC65816CCUnsigned(WDC65816CC) ? ISD::ZERO_EXTEND : ISD::SIGN_EXTEND;
      Op0 = DAG.getNode(ExtendOp, DL, MVT::i32, Op0);
      Op1 = DAG.getNode(ExtendOp, DL, MVT::i32, Op1);
    }
    // Use SUB instead of CMP to enable CSE between SUB and CMP.
    SDVTList VTs = DAG.getVTList(Op0.getValueType(), MVT::i8);
    SDValue Sub = DAG.getNode(WDC65816ISD::SUB, DL, VTs, Op0, Op1);
    return SDValue(Sub.getNode(), 1);
  }
  return DAG.getNode(WDC65816ISD::CMP, DL, MVT::i8, Op0, Op1);
}

/// Result of 'and' or 'trunc to i1' is compared against zero.
/// Change to a BTST node if possible.
SDValue WDC65816TargetLowering::LowerToBTST(SDValue Op, ISD::CondCode CC,
                                        const SDLoc &DL,
                                        SelectionDAG &DAG) const {
...
SDValue WDC65816TargetLowering::LowerSETCC(SDValue Op, SelectionDAG &DAG) const {
  ...
  if ((isOneConstant(Op1) || isNullConstant(Op1)) &&
    ...
    if (Op0.getOpcode() == WDC65816ISD::SETCC) {
      WDC65816::CondCode CCode = (WDC65816::CondCode)Op0.getConstantOperandVal(0);
      bool Invert = (CC == ISD::SETNE) ^ isNullConstant(Op1);
      if (!Invert)
        return Op0;

      CCode = WDC65816::GetOppositeBranchCondition(CCode);
      SDValue SetCC =
          DAG.getNode(WDC65816ISD::SETCC, DL, MVT::i8,
  ...
  unsigned WDC65816CC = TranslateWDC65816CC(CC, DL, IsFP, Op0, Op1, DAG);
  if (WDC65816CC == WDC65816::COND_INVALID)
    return SDValue();

  SDValue CCR = EmitCmp(Op0, Op1, WDC65816CC, DL, DAG);
  return DAG.getNode(WDC65816ISD::SETCC, DL, MVT::i8,
                     DAG.getConstant(WDC65816CC, DL, MVT::i8), CCR);
}

SDValue WDC65816TargetLowering::LowerSETCCCARRY(SDValue Op,
                                            SelectionDAG &DAG) const {
  ...
  WDC65816::CondCode CC = TranslateIntegerWDC65816CC(cast<CondCodeSDNode>(Cond)->get());

  EVT CarryVT = Carry.getValueType();
  APInt NegOne = APInt::getAllOnes(CarryVT.getScalarSizeInBits());
  Carry = DAG.getNode(WDC65816ISD::ADD, DL, DAG.getVTList(CarryVT, MVT::i32), Carry,
                      DAG.getConstant(NegOne, DL, CarryVT));

  SDVTList VTs = DAG.getVTList(LHS.getValueType(), MVT::i32);
  SDValue Cmp =
      DAG.getNode(WDC65816ISD::SUBX, DL, VTs, LHS, RHS, Carry.getValue(1));

  return DAG.getNode(WDC65816ISD::SETCC, DL, MVT::i8,
                     DAG.getConstant(CC, DL, MVT::i8), Cmp.getValue(1));
}

/// Return true if opcode is a WDC65816 logical comparison.
static bool isWDC65816LogicalCmp(SDValue Op) {
  unsigned Opc = Op.getNode()->getOpcode();
  if (Opc == WDC65816ISD::CMP)
    return true;
  if (Op.getResNo() == 1 &&
      (Opc == WDC65816ISD::ADD || Opc == WDC65816ISD::SUB || Opc == WDC65816ISD::ADDX ||
       Opc == WDC65816ISD::SUBX || Opc == WDC65816ISD::SMUL || Opc == WDC65816ISD::UMUL ||
       Opc == WDC65816ISD::OR || Opc == WDC65816ISD::XOR || Opc == WDC65816ISD::AND))
    return true;

  if (Op.getResNo() == 2 && Opc == WDC65816ISD::UMUL)
    return true;
...
SDValue WDC65816TargetLowering::LowerSELECT(SDValue Op, SelectionDAG &DAG) const {
  bool addTest = true;
  ...
  // (select (x != 0), y, -1) -> (sign_bit (x - 1)) | y
  // (select (x != 0), -1, y) -> ~(sign_bit (x - 1)) | y
  if (Cond.getOpcode() == WDC65816ISD::SETCC &&
      Cond.getOperand(1).getOpcode() == WDC65816ISD::CMP &&
    ...
    if ((isAllOnesConstant(Op1) || isAllOnesConstant(Op2)) &&
        (CondCode == WDC65816::COND_EQ || CondCode == WDC65816::COND_NE)) {
      ...
      if (isNullConstant(Y) &&
          (isAllOnesConstant(Op1) == (CondCode == WDC65816::COND_NE))) {

        SDVTList VTs = DAG.getVTList(CmpOp0.getValueType(), MVT::i32);

        SDValue Neg =
            DAG.getNode(WDC65816ISD::SUB, DL, VTs,
                        DAG.getConstant(0, DL, CmpOp0.getValueType()), CmpOp0);

        SDValue Res = DAG.getNode(WDC65816ISD::SETCC_CARRY, DL, Op.getValueType(),
                                  DAG.getConstant(WDC65816::COND_CS, DL, MVT::i8),
                                  SDValue(Neg.getNode(), 1));
        return Res;
      }

      Cmp = DAG.getNode(WDC65816ISD::CMP, DL, MVT::i8,
                        DAG.getConstant(1, DL, CmpOp0.getValueType()), CmpOp0);

      SDValue Res = // Res = 0 or -1.
          DAG.getNode(WDC65816ISD::SETCC_CARRY, DL, Op.getValueType(),
                      DAG.getConstant(WDC65816::COND_CS, DL, MVT::i8), Cmp);

      if (isAllOnesConstant(Op1) != (CondCode == WDC65816::COND_EQ))
  ...
  if (Cond.getOpcode() == ISD::AND &&
      Cond.getOperand(0).getOpcode() == WDC65816ISD::SETCC_CARRY &&
      isOneConstant(Cond.getOperand(1)))
    Cond = Cond.getOperand(0);

  // If condition flag is set by a WDC65816ISD::CMP, then use it as the condition
  // setting operand in place of the WDC65816ISD::SETCC.
  unsigned CondOpcode = Cond.getOpcode();
  if (CondOpcode == WDC65816ISD::SETCC || CondOpcode == WDC65816ISD::SETCC_CARRY) {
    ...
    if ((isWDC65816LogicalCmp(Cmp) && !IllegalFPCMov) || Opc == WDC65816ISD::BTST) {
      Cond = Cmp;
      addTest = false;
    }
  ...
  if (addTest) {
    CC = DAG.getConstant(WDC65816::COND_NE, DL, MVT::i8);
    Cond = EmitTest(Cond, WDC65816::COND_NE, DL, DAG);
  }
  ...
  // a >= b ? -1 :  0 -> RES = setcc_carry
  // a >= b ?  0 : -1 -> RES = ~setcc_carry
  if (Cond.getOpcode() == WDC65816ISD::SUB) {
    unsigned CondCode = CC->getAsZExtVal();

    if ((CondCode == WDC65816::COND_CC || CondCode == WDC65816::COND_CS) &&
        (isAllOnesConstant(Op1) || isAllOnesConstant(Op2)) &&
        (isNullConstant(Op1) || isNullConstant(Op2))) {
      SDValue Res =
          DAG.getNode(WDC65816ISD::SETCC_CARRY, DL, Op.getValueType(),
                      DAG.getConstant(WDC65816::COND_CS, DL, MVT::i8), Cond);
      if (isAllOnesConstant(Op1) != (CondCode == WDC65816::COND_CS))
        return DAG.getNOT(DL, Res, Res.getValueType());
      return Res;
    }
  }

  // WDC65816 doesn't have an i8 cmov. If both operands are the result of a
  ...
  if (Op.getValueType() == MVT::i8 && Op1.getOpcode() == ISD::TRUNCATE &&
    ...
    if (T1.getValueType() == T2.getValueType() &&
      ...
      SDValue Cmov = DAG.getNode(WDC65816ISD::CMOV, DL, VTs, T2, T1, CC, Cond);
      return DAG.getNode(ISD::TRUNCATE, DL, Op.getValueType(), Cmov);
    }
  }

  // Simple optimization when Cond is a constant to avoid generating
  // WDC65816ISD::CMOV if possible.
  ...
  // WDC65816ISD::CMOV means set the result (which is operand 1) to the RHS if
  // condition is true.
  SDVTList VTs = DAG.getVTList(Op.getValueType(), MVT::Glue);
  SDValue Ops[] = {Op2, Op1, CC, Cond};
  return DAG.getNode(WDC65816ISD::CMOV, DL, VTs, Ops);
}

/// Return true if node is an ISD::AND or ISD::OR of two WDC65816::SETcc nodes
/// each of which has no other use apart from the AND / OR.
static bool isAndOrOfSetCCs(SDValue Op, unsigned &Opc) {
  Opc = Op.getOpcode();
  if (Opc != ISD::OR && Opc != ISD::AND)
    return false;
  return (WDC65816::IsSETCC(Op.getOperand(0).getOpcode()) &&
          Op.getOperand(0).hasOneUse() &&
          WDC65816::IsSETCC(Op.getOperand(1).getOpcode()) &&
          Op.getOperand(1).hasOneUse());
}

/// Return true if node is an ISD::XOR of a WDC65816ISD::SETCC and 1 and that the
/// SETCC node has a single use.
static bool isXor1OfSetCC(SDValue Op) {
  if (Op.getOpcode() != ISD::XOR)
    return false;
  if (isOneConstant(Op.getOperand(1)))
    return Op.getOperand(0).getOpcode() == WDC65816ISD::SETCC &&
           Op.getOperand(0).hasOneUse();
  return false;
}

SDValue WDC65816TargetLowering::LowerBRCOND(SDValue Op, SelectionDAG &DAG) const {
  bool AddTest = true;
  ...
  if (CondOpcode == WDC65816ISD::SETCC || CondOpcode == WDC65816ISD::SETCC_CARRY) {
    ...
    if (isWDC65816LogicalCmp(Cmp) || Opc == WDC65816ISD::BTST) {
      Cond = Cmp;
      AddTest = false;
    } else {
  ...
  if (isOverflowArithmetic(CondOpcode)) {
    ...
    if (Inverted)
      CCode = WDC65816::GetOppositeBranchCondition((WDC65816::CondCode)CCode);
    CC = DAG.getConstant(CCode, DL, MVT::i8);
    ...
    if (Cond.hasOneUse() && isAndOrOfSetCCs(Cond, CondOpc)) {
      ...
      if (CondOpc == ISD::OR) {
        ...
        // separate test.
        if (Cmp == Cond.getOperand(1).getOperand(1) && isWDC65816LogicalCmp(Cmp)) {
          CC = Cond.getOperand(0).getOperand(0);
          Chain = DAG.getNode(WDC65816ISD::BRCOND, DL, Op.getValueType(), Chain,
                              Dest, CC, Cmp);
        ...
        if (Cmp == Cond.getOperand(1).getOperand(1) && isWDC65816LogicalCmp(Cmp) &&
          ...
          WDC65816::CondCode CCode =
              (WDC65816::CondCode)Cond.getOperand(0).getConstantOperandVal(0);
          CCode = WDC65816::GetOppositeBranchCondition(CCode);
          CC = DAG.getConstant(CCode, DL, MVT::i8);
          ...
          if (User->getOpcode() == ISD::BR) {
            ...
            Chain = DAG.getNode(WDC65816ISD::BRCOND, DL, Op.getValueType(), Chain,
                                Dest, CC, Cmp);
            WDC65816::CondCode CCode =
                (WDC65816::CondCode)Cond.getOperand(1).getConstantOperandVal(0);
            CCode = WDC65816::GetOppositeBranchCondition(CCode);
            CC = DAG.getConstant(CCode, DL, MVT::i8);
            Cond = Cmp;
            AddTest = false;
  ...
  if (AddTest) {
    WDC65816::CondCode MxCond = Inverted ? WDC65816::COND_EQ : WDC65816::COND_NE;
    CC = DAG.getConstant(MxCond, DL, MVT::i8);
    Cond = EmitTest(Cond, MxCond, DL, DAG);
  }
  return DAG.getNode(WDC65816ISD::BRCOND, DL, Op.getValueType(), Chain, Dest, CC,
                     Cond);
}

SDValue WDC65816TargetLowering::LowerADDC_ADDE_SUBC_SUBE(SDValue Op,
                                                     SelectionDAG &DAG) const {
...
// their target countpart wrapped in the WDC65816ISD::Wrapper node. Suppose N is
...
SDValue WDC65816TargetLowering::LowerConstantPool(SDValue Op,
  ...
  unsigned WrapperKind = WDC65816ISD::Wrapper;
  if (WDC65816II::isPCRelGlobalReference(OpFlag)) {
    WrapperKind = WDC65816ISD::WrapperPC;
  }
  ...
  if (WDC65816II::isGlobalRelativeToPICBase(OpFlag)) {
    Result = DAG.getNode(ISD::ADD, DL, PtrVT,
                         DAG.getNode(WDC65816ISD::GLOBAL_BASE_REG, SDLoc(), PtrVT),
                         Result);
  }
...
SDValue WDC65816TargetLowering::LowerExternalSymbol(SDValue Op,
                                                SelectionDAG &DAG) const {
  ...
  // load.
  if (WDC65816II::isGlobalStubReference(OpFlag)) {
...
SDValue WDC65816TargetLowering::LowerBlockAddress(SDValue Op,
  ...
  if (WDC65816II::isPCRelBlockReference(OpFlags)) {
    Result = DAG.getNode(WDC65816ISD::WrapperPC, DL, PtrVT, Result);
  } else {
    Result = DAG.getNode(WDC65816ISD::Wrapper, DL, PtrVT, Result);
  }

  // With PIC, the address is actually $g + Offset.
  if (WDC65816II::isGlobalRelativeToPICBase(OpFlags)) {
    Result =
        DAG.getNode(ISD::ADD, DL, PtrVT,
                    DAG.getNode(WDC65816ISD::GLOBAL_BASE_REG, DL, PtrVT), Result);
  }

  return Result;
}

SDValue WDC65816TargetLowering::LowerGlobalAddress(const GlobalValue *GV,
  ...
  SDValue Result;
  if (WDC65816II::isDirectGlobalReference(OpFlags)) {
  ...
  if (WDC65816II::isPCRelGlobalReference(OpFlags))
    Result = DAG.getNode(WDC65816ISD::WrapperPC, DL, PtrVT, Result);
  else
    Result = DAG.getNode(WDC65816ISD::Wrapper, DL, PtrVT, Result);
  ...
  // load.
  if (WDC65816II::isGlobalStubReference(OpFlags)) {
    Result = DAG.getLoad(PtrVT, DL, DAG.getEntryNode(), Result,
                         MachinePointerInfo::getGOT(DAG.getMachineFunction()));
  }
...
SDValue WDC65816TargetLowering::LowerJumpTable(SDValue Op,
                                           SelectionDAG &DAG) const {
...
unsigned WDC65816TargetLowering::getJumpTableEncoding() const {
  return Subtarget.getJumpTableEncoding();
}

const MCExpr *WDC65816TargetLowering::LowerCustomJumpTableEntry(
...
SDValue WDC65816TargetLowering::getPICJumpTableRelocBase(SDValue Table,
                                                     SelectionDAG &DAG) const {
  if (getJumpTableEncoding() == MachineJumpTableInfo::EK_Custom32)
    return DAG.getNode(WDC65816ISD::GLOBAL_BASE_REG, SDLoc(),
                       getPointerTy(DAG.getDataLayout()));
...
const MCExpr *WDC65816TargetLowering::getPICJumpTableRelocBaseExpr(
    const MachineFunction *MF, unsigned JTI, MCContext &Ctx) const {
  return MCSymbolRefExpr::create(MF->getJTISymbol(JTI, Ctx), Ctx);
}

WDC65816TargetLowering::ConstraintType
WDC65816TargetLowering::getConstraintType(StringRef Constraint) const {
...
void WDC65816TargetLowering::LowerAsmOperandForConstraint(SDValue Op,
...
WDC65816TargetLowering::getRegForInlineAsmConstraint(const TargetRegisterInfo *TRI,
                                                 StringRef Constraint,
                                                 MVT VT) const {
  if (Constraint.size() == 1) {
    switch (Constraint[0]) {
    ...
    case 'd':
      switch (VT.SimpleTy) {
      case MVT::i8:
        return std::make_pair(0U, &WDC65816::DR8RegClass);
      case MVT::i16:
        return std::make_pair(0U, &WDC65816::DR16RegClass);
      case MVT::i32:
        return std::make_pair(0U, &WDC65816::DR32RegClass);
      default:
        break;
      }
      break;
    case 'a':
      switch (VT.SimpleTy) {
      case MVT::i16:
        return std::make_pair(0U, &WDC65816::AR16RegClass);
      case MVT::i32:
        return std::make_pair(0U, &WDC65816::AR32RegClass);
      default:
        break;
      }
      break;
...
bool WDC65816::isCalleePop(CallingConv::ID CC, bool IsVarArg, bool GuaranteeTCO) {
  return CC == CallingConv::WDC65816_RTD && !IsVarArg;
}
...
static bool isCMOVPseudo(MachineInstr &MI) {
  switch (MI.getOpcode()) {
  case WDC65816::CMOV8d:
  case WDC65816::CMOV16d:
  case WDC65816::CMOV32r:
    return true;
...
static bool checkAndUpdateCCRKill(MachineBasicBlock::iterator SelectItr,
  ...
  for (MachineBasicBlock::iterator miE = BB->end(); miI != miE; ++miI) {
    ...
    if (mi.readsRegister(WDC65816::CCR, /*TRI=*/nullptr))
      return false;
    if (mi.definesRegister(WDC65816::CCR, /*TRI=*/nullptr))
  ...
  if (miI == BB->end())
    for (const auto *SBB : BB->successors())
      if (SBB->isLiveIn(WDC65816::CCR))
        return false;

  // We found a def, or hit the end of the basic block and CCR wasn't live
  // out. SelectMI should have a kill flag on CCR.
  SelectItr->addRegisterKilled(WDC65816::CCR, TRI);
  return true;
}

MachineBasicBlock *
WDC65816TargetLowering::EmitLoweredSelect(MachineInstr &MI,
  ...
  WDC65816::CondCode CC = WDC65816::CondCode(MI.getOperand(3).getImm());
  WDC65816::CondCode OppCC = WDC65816::GetOppositeBranchCondition(CC);
  ...
  if (CascadedCMOV) {
    ...
    F->insert(It, Jcc1MBB);
    Jcc1MBB->addLiveIn(WDC65816::CCR);
  }
  ...
  if (!LastCCRSUser->killsRegister(WDC65816::CCR, /*TRI=*/nullptr) &&
      !checkAndUpdateCCRKill(LastCCRSUser, MBB, TRI)) {
    Copy0MBB->addLiveIn(WDC65816::CCR);
    SinkMBB->addLiveIn(WDC65816::CCR);
  }
  ...
  unsigned Opc = WDC65816::GetCondBranchFromCond(CC);
  BuildMI(MBB, DL, TII->get(Opc)).addMBB(SinkMBB);

  if (CascadedCMOV) {
    unsigned Opc2 = WDC65816::GetCondBranchFromCond(
        (WDC65816::CondCode)CascadedCMOV->getOperand(3).getImm());
  ...
  for (MachineBasicBlock::iterator MIIt = MIItBegin; MIIt != MIItEnd; ++MIIt) {
    ...
    MIB =
        BuildMI(*SinkMBB, SinkInsertionPoint, DL, TII->get(WDC65816::PHI), DestReg)
            .addReg(Op1Reg)
            .addMBB(Copy0MBB)
            .addReg(Op2Reg)
            .addMBB(ThisMBB);
...
MachineBasicBlock *
WDC65816TargetLowering::EmitLoweredSegAlloca(MachineInstr &MI,
...
WDC65816TargetLowering::EmitInstrWithCustomInserter(MachineInstr &MI,
  ...
  case WDC65816::SALLOCA:
    return EmitLoweredSegAlloca(MI, BB);
  }
}

SDValue WDC65816TargetLowering::LowerVASTART(SDValue Op, SelectionDAG &DAG) const {
  MachineFunction &MF = DAG.getMachineFunction();
...
SDValue WDC65816TargetLowering::LowerATOMICFENCE(SDValue Op,
                                             SelectionDAG &DAG) const {
...
// correct sequence.
SDValue WDC65816TargetLowering::LowerDYNAMIC_STACKALLOC(SDValue Op,
                                                    SelectionDAG &DAG) const {
  MachineFunction &MF = DAG.getMachineFunction();
  ...
  if (SplitStack) {
    ...
    Result = DAG.getNode(WDC65816ISD::SEG_ALLOCA, DL, SPTy, Chain,
...
SDValue WDC65816TargetLowering::LowerShiftLeftParts(SDValue Op,
                                                SelectionDAG &DAG) const {
  SDLoc DL(Op);
...
SDValue WDC65816TargetLowering::LowerShiftRightParts(SDValue Op, SelectionDAG &DAG,
                                                 bool IsSRA) const {
  SDLoc DL(Op);
  SDValue Lo = Op.getOperand(0);
  SDValue Hi = Op.getOperand(1);
...
static SDValue getSETCC(WDC65816::CondCode Cond, SDValue CCR, const SDLoc &dl,
                        SelectionDAG &DAG) {
  return DAG.getNode(WDC65816ISD::SETCC, dl, MVT::i8,
...
static SDValue combineCarryThroughADD(SDValue CCR) {
  if (CCR.getOpcode() == WDC65816ISD::ADD) {
    if (isAllOnesConstant(CCR.getOperand(1))) {
      ...
      if (Carry.getOpcode() == WDC65816ISD::SETCC ||
          Carry.getOpcode() == WDC65816ISD::SETCC_CARRY) {
        if (Carry.getConstantOperandVal(0) == WDC65816::COND_CS)
...
/// of chain values.
static SDValue combineSetCCCCR(SDValue CCR, WDC65816::CondCode &CC,
                               SelectionDAG &DAG,
                               const WDC65816Subtarget &Subtarget) {
  if (CC == WDC65816::COND_CS)
...
// Optimize  RES = WDC65816ISD::SETCC CONDCODE, CCR_INPUT
static SDValue combineWDC65816SetCC(SDNode *N, SelectionDAG &DAG,
                                const WDC65816Subtarget &Subtarget) {
  SDLoc DL(N);
  WDC65816::CondCode CC = WDC65816::CondCode(N->getConstantOperandVal(0));
...
static SDValue combineWDC65816BrCond(SDNode *N, SelectionDAG &DAG,
                                 const WDC65816Subtarget &Subtarget) {
  SDLoc DL(N);
  WDC65816::CondCode CC = WDC65816::CondCode(N->getConstantOperandVal(2));
  ...
  if (SDValue Flags = combineSetCCCCR(CCR, CC, DAG, Subtarget)) {
    ...
    return DAG.getNode(WDC65816ISD::BRCOND, DL, N->getVTList(), N->getOperand(0),
...
static SDValue combineSUBX(SDNode *N, SelectionDAG &DAG) {
  if (SDValue Flags = combineCarryThroughADD(N->getOperand(2))) {
    ...
    return DAG.getNode(WDC65816ISD::SUBX, SDLoc(N), VTs, N->getOperand(0),
...
// Optimize RES, CCR = WDC65816ISD::ADDX LHS, RHS, CCR
static SDValue combineADDX(SDNode *N, SelectionDAG &DAG,
                           TargetLowering::DAGCombinerInfo &DCI) {
  if (SDValue Flags = combineCarryThroughADD(N->getOperand(2))) {
    MVT VT = N->getSimpleValueType(0);
    SDVTList VTs = DAG.getVTList(VT, MVT::i32);
    return DAG.getNode(WDC65816ISD::ADDX, SDLoc(N), VTs, N->getOperand(0),
                       N->getOperand(1), Flags);
  }
...
SDValue WDC65816TargetLowering::PerformDAGCombine(SDNode *N,
                                              DAGCombinerInfo &DCI) const {
  SelectionDAG &DAG = DCI.DAG;
  switch (N->getOpcode()) {
  case WDC65816ISD::SUBX:
    return combineSUBX(N, DAG);
  case WDC65816ISD::ADDX:
    return combineADDX(N, DAG, DCI);
  case WDC65816ISD::SETCC:
    return combineWDC65816SetCC(N, DAG, Subtarget);
  case WDC65816ISD::BRCOND:
    return combineWDC65816BrCond(N, DAG, Subtarget);
  }
...
//===----------------------------------------------------------------------===//
// WDC65816ISD Node Names
//===----------------------------------------------------------------------===//
const char *WDC65816TargetLowering::getTargetNodeName(unsigned Opcode) const {
  switch (Opcode) {
  case WDC65816ISD::CALL:
    return "WDC65816ISD::CALL";
  case WDC65816ISD::TAIL_CALL:
    return "WDC65816ISD::TAIL_CALL";
  case WDC65816ISD::RET:
    return "WDC65816ISD::RET";
  case WDC65816ISD::TC_RETURN:
    return "WDC65816ISD::TC_RETURN";
  case WDC65816ISD::ADD:
    return "WDC65816ISD::ADD";
  case WDC65816ISD::SUB:
    return "WDC65816ISD::SUB";
  case WDC65816ISD::ADDX:
    return "WDC65816ISD::ADDX";
  case WDC65816ISD::SUBX:
    return "WDC65816ISD::SUBX";
  case WDC65816ISD::SMUL:
    return "WDC65816ISD::SMUL";
  case WDC65816ISD::UMUL:
    return "WDC65816ISD::UMUL";
  case WDC65816ISD::OR:
    return "WDC65816ISD::OR";
  case WDC65816ISD::XOR:
    return "WDC65816ISD::XOR";
  case WDC65816ISD::AND:
    return "WDC65816ISD::AND";
  case WDC65816ISD::CMP:
    return "WDC65816ISD::CMP";
  case WDC65816ISD::BTST:
    return "WDC65816ISD::BTST";
  case WDC65816ISD::SELECT:
    return "WDC65816ISD::SELECT";
  case WDC65816ISD::CMOV:
    return "WDC65816ISD::CMOV";
  case WDC65816ISD::BRCOND:
    return "WDC65816ISD::BRCOND";
  case WDC65816ISD::SETCC:
    return "WDC65816ISD::SETCC";
  case WDC65816ISD::SETCC_CARRY:
    return "WDC65816ISD::SETCC_CARRY";
  case WDC65816ISD::GLOBAL_BASE_REG:
    return "WDC65816ISD::GLOBAL_BASE_REG";
  case WDC65816ISD::Wrapper:
    return "WDC65816ISD::Wrapper";
  case WDC65816ISD::WrapperPC:
    return "WDC65816ISD::WrapperPC";
  case WDC65816ISD::SEG_ALLOCA:
    return "WDC65816ISD::SEG_ALLOCA";
  default:
    return NULL;
  }
}

CCAssignFn *WDC65816TargetLowering::getCCAssignFn(CallingConv::ID CC, bool Return,
                                              bool IsVarArg) const {
  if (Return)
    return RetCC_WDC65816_C;
  else
    return CC_WDC65816_C;
}
