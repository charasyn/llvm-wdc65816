...
#ifndef LLVM_LIB_TARGET_WDC65816_WDC65816ISELLOWERING_H
#define LLVM_LIB_TARGET_WDC65816_WDC65816ISELLOWERING_H
...
namespace llvm {
namespace WDC65816ISD {

/// WDC65816 Specific DAG nodes
enum NodeType {
  ...
  /// WDC65816 compare and logical compare instructions. Subtracts the source
  ...
  /// WDC65816 bit-test instructions.
  BTST,

  /// WDC65816 Select
  SELECT,

  /// WDC65816 SetCC. Operand 0 is condition code, and operand 1 is the CCR
  ...
  /// WDC65816 conditional moves. Operand 0 and operand 1 are the two values
  /// to select from. Operand 2 is the condition code, and operand 3 is the
  /// flag operand produced by a CMP or TEST instruction. It also writes a
  /// flag result.
  CMOV,

  /// WDC65816 conditional branches. Operand 0 is the chain operand, operand 1
  ...
  /// Special wrapper used under WDC65816 PIC mode for PC
...
public:
  explicit WDC65816TargetLowering(const WDC65816TargetMachine &TM,
                              const WDC65816Subtarget &STI);

  static const WDC65816TargetLowering *create(const WDC65816TargetMachine &TM,
                                          const WDC65816Subtarget &STI);
...
private:
  ...
  SDValue getWDC65816ReadTp(SDLoc Loc, SelectionDAG &DAG) const;
  ...
  /// equivalent, for use with the given WDC65816 condition code.
  SDValue EmitTest(SDValue Op0, unsigned WDC65816CC, const SDLoc &dl,
                   SelectionDAG &DAG) const;

  /// Emit nodes that will be selected as "cmp Op0,Op1", or something
  /// equivalent, for use with the given WDC65816 condition code.
  SDValue EmitCmp(SDValue Op0, SDValue Op1, unsigned WDC65816CC, const SDLoc &dl,
                  SelectionDAG &DAG) const;
...
#endif // LLVM_LIB_TARGET_WDC65816_WDC65816ISELLOWERING_H
